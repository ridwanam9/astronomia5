...
<section class="masthead text-white text-center" style="background-image: url('assets/assets/img/universe.jpg');
  ...
  background-attachment: fixed;">
    <div class="container d-flex align-items-center flex-column">
        ...
        <h1 class="masthead-heading text-uppercase mb-0">Edit Petanyaan Anda</h1>
        <br>
        <br>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-xl-7">
                <form id="contactForm" method="POST" action="{{ route('tanya.update', $tanya->id) }}">
                    @csrf
                    @method('patch')
                    <!-- Name input-->
                    ...
                    <!-- Message input-->
                    <div class="form-floating mb-3">
                        <textarea class="form-control rounded @error('judul') is-invalid @enderror" name="judul" placeholder="Judul" style="height: 10rem" data-sb-validations="required">{{ old('judul', $tanya->judul) }}</textarea>
