            ...
            <div class="col-lg-8 col-xl-7">
                ...
                <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="POST"
                    ...
                    <div class="form-floating mb-3">
                        <input class="form-control rounded @error('title') is-invalid @enderror" type="text" name="title" placeholder="title" value="{{ old('title', $kakastro->title) }}" />
                    ...
                    <!-- Email address input-->
                    <div class="form-floating mb-3">
                        <input class="form-control rounded @error('gambar') is-invalid @enderror" type="file" name="gambar" placeholder="gambar" value="{{ old('gambar', $kakastro->gambar) }}" />
                    ...
                    <!-- Message input-->
                    <div class="form-floating mb-3">
                        <textarea class="form-control rounded @error('body') is-invalid @enderror" name="body" placeholder="body" style="height: 20rem">{{ old('body', $kakastro->body) }}</textarea>
